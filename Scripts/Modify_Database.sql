...
INSERT INTO ZUTATENZUWEISUNG (REZEPTID, ZUTATENNR, MENGE) VALUES ('R0', 9902, 250);  -- Lasagneplatten (Gramm)
INSERT INTO ZUTATENZUWEISUNG (REZEPTID, ZUTATENNR, MENGE) VALUES ('R0', 3001, 500);  -- Vollmilch (ml)
INSERT INTO ZUTATENZUWEISUNG (REZEPTID, ZUTATENNR, MENGE) VALUES ('R0', 3003, 50);   -- Butter (Gramm)
INSERT INTO ZUTATENZUWEISUNG (REZEPTID, ZUTATENNR, MENGE) VALUES ('R0', 7043, 2);    -- Gemüsebrühe (Würfel)
INSERT INTO ZUTATENZUWEISUNG (REZEPTID, ZUTATENNR, MENGE) VALUES ('R0', 9003, 5);   -- Muskat (Gramm)

-- Zutaten für Thaicurry mit Hähnchen (R1)
INSERT INTO ZUTATENZUWEISUNG (REZEPTID, ZUTATENNR, MENGE) VALUES ('R1', 9901, 200);  -- Reis (Gramm)
INSERT INTO ZUTATENZUWEISUNG (REZEPTID, ZUTATENNR, MENGE) VALUES ('R1', 1002, 1);    -- Zwiebel (Stück)
INSERT INTO ZUTATENZUWEISUNG (REZEPTID, ZUTATENNR, MENGE) VALUES ('R1', 1005, 2);   -- Karotte (Stück)
INSERT INTO ZUTATENZUWEISUNG (REZEPTID, ZUTATENNR, MENGE) VALUES ('R1', 1008, 1);   -- Lauch (Stück)

-- Zutaten für Kartoffelsuppe (R2)
INSERT INTO ZUTATENZUWEISUNG (REZEPTID, ZUTATENNR, MENGE) VALUES ('R2', 1006, 4);   -- Kartoffel (Stück)
INSERT INTO ZUTATENZUWEISUNG (REZEPTID, ZUTATENNR, MENGE) VALUES ('R2', 1005, 1);   -- Karotte (Stück)
INSERT INTO ZUTATENZUWEISUNG (REZEPTID, ZUTATENNR, MENGE) VALUES ('R2', 1002, 1);   -- Zwiebel (Stück)
INSERT INTO ZUTATENZUWEISUNG (REZEPTID, ZUTATENNR, MENGE) VALUES ('R2', 1008, 1);   -- Lauch (Stück)
INSERT INTO ZUTATENZUWEISUNG (REZEPTID, ZUTATENNR, MENGE) VALUES ('R2', 7043, 1);   -- Gemüsebrühe (Würfel)
INSERT INTO ZUTATENZUWEISUNG (REZEPTID, ZUTATENNR, MENGE) VALUES ('R2', 5001, 2);   -- Wiener Würstchen (Paar) oder
INSERT INTO ZUTATENZUWEISUNG (REZEPTID, ZUTATENNR, MENGE) VALUES ('R2', 9001, 2);   -- Tofu-Würstchen (Stück)

-- Zutaten für Milchreis mit Apfelmus (R3)
INSERT INTO ZUTATENZUWEISUNG (REZEPTID, ZUTATENNR, MENGE) VALUES ('R3', 9901, 100);  -- Reis (Gramm)
INSERT INTO ZUTATENZUWEISUNG (REZEPTID, ZUTATENNR, MENGE) VALUES ('R3', 3001, 500);  -- Vollmilch (ml)
INSERT INTO ZUTATENZUWEISUNG (REZEPTID, ZUTATENNR, MENGE) VALUES ('R3', 3003, 20);   -- Butter (Gramm)
INSERT INTO ZUTATENZUWEISUNG (REZEPTID, ZUTATENNR, MENGE) VALUES ('R3', 2001, 2);    -- Apfel (Stück)

-- Zutaten für Sommerlicher Couscous-Salat (R4)
INSERT INTO ZUTATENZUWEISUNG (REZEPTID, ZUTATENNR, MENGE) VALUES ('R4', 6408, 200);  -- Couscous (Gramm)
INSERT INTO ZUTATENZUWEISUNG (REZEPTID, ZUTATENNR, MENGE) VALUES ('R4', 7043, 1);    -- Gemüsebrühe (Würfel)
INSERT INTO ZUTATENZUWEISUNG (REZEPTID, ZUTATENNR, MENGE) VALUES ('R4', 1003, 2);    -- Tomate (Stück)
INSERT INTO ZUTATENZUWEISUNG (REZEPTID, ZUTATENNR, MENGE) VALUES ('R4', 1005, 1);    -- Karotte (Stück)
INSERT INTO ZUTATENZUWEISUNG (REZEPTID, ZUTATENNR, MENGE) VALUES ('R4', 1012, 1);   -- Schnittlauch (Bund)
